# Seed difficulty: the full analysis

The long version of the [README](../README.md): what the data looks like, the traps
in it, and how the model was checked.

The numbers below come from an earlier pull of 523k ranked matches across all
seasons. The dataset is being rebuilt as season 10 onward, and these get rerun
once that finishes.
...
re-download of a whole season cannot.
...
elo gets you 2.97. Adding every seed feature buys about 2 more seconds.
...
- Forfeits are more than half of ranked matches, and dropping them biases every number here the
